 ...
 */
package kr.co.esjee.ranker.hwp;

import kr.co.esjee.ranker.hwp.v3.HwpTextExtractorV3;
import kr.co.esjee.ranker.hwp.v5.HwpTextExtractorV5;
...
public abstract class HwpTextExtractor {
	...
	public static boolean extract(File source, Writer writer) throws IOException {
