 ...
 */
package kr.co.esjee.ranker.hwp.v5;

import kr.co.esjee.ranker.hwp.utils.HwpStreamReader;
...
public abstract class HwpTextExtractorV5 {
	...
	private static void writeParaHeader(HwpStreamReader sectionStream, long length, StringBuffer buf) throws IOException {
